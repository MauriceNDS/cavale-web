export default {
  ...
  session: {
    ...
    skip: 'Passer',
    move: 'Déplacer',
    skipConfirm: 'Si tu passes cette séance, elle comptera comme manquée dans la progression de la semaine.',
  ...
  report: {
    ...
    chartDplus: 'Dénivelé (m)',
    chartModeLinear: 'Linéaire',
    chartModePerKm: 'Par km',
    chartModePerSegment: 'Par segment',
    chartModeAria: 'Mode du graphique',
    chartMetricAria: 'Métrique du graphique',
    tabPace: 'Allure',
    tabHr: 'FC',
    tabCadence: 'Cadence',
    tabElevation: 'Profil',
    tabDplus: 'D+',
    showSplitsTable: 'Tableau détaillé',
